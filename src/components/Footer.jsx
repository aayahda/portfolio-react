...
function Footer(){
    ...
    <div className="fbuttons">
        <p>
          ...
          <p>  <Fab size="small" className="custom-fab" style={{backgroundColor:'#262626',boxShadow:"none"}}>
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0,0,256,256">
                    <g fill="#a3a3a3" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style={{mixBlendMode: "normal"}}>
                        <g transform="scale(8.53333,8.53333)">
        ...
        <p><Fab size="small" className="custom-fab" style={{backgroundColor:'#262626',boxShadow:"none"}}><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0,0,256,256">
